...
h264ProfileLevelId.ProfileConstrainedBaseline;
h264ProfileLevelId.ProfileBaseline;
h264ProfileLevelId.ProfileMain;
h264ProfileLevelId.ProfileConstrainedHigh;
h264ProfileLevelId.ProfileHigh;
h264ProfileLevelId.ProfilePredictiveHigh444;
h264ProfileLevelId.Level1_b;
h264ProfileLevelId.Level1;
h264ProfileLevelId.Level1_1;
h264ProfileLevelId.Level1_2;
h264ProfileLevelId.Level1_3;
h264ProfileLevelId.Level2;
h264ProfileLevelId.Level2_1;
h264ProfileLevelId.Level2_2;
h264ProfileLevelId.Level3;
h264ProfileLevelId.Level3_1;
h264ProfileLevelId.Level3_2;
h264ProfileLevelId.Level4;
h264ProfileLevelId.Level4_1;
h264ProfileLevelId.Level4_2;
h264ProfileLevelId.Level5;
h264ProfileLevelId.Level5_1;
h264ProfileLevelId.Level5_2;
h264ProfileLevelId.ProfileLevelId;
h264ProfileLevelId.parseProfileLevelId;
h264ProfileLevelId.profileLevelIdToString;
h264ProfileLevelId.profileToString;
h264ProfileLevelId.levelToString;
h264ProfileLevelId.parseSdpProfileLevelId;
h264ProfileLevelId.isSameProfile;
h264ProfileLevelId.generateProfileLevelIdForAnswer;
...
ortc.getRecvRtpCapabilities;
ortc.getExtendedRtpCapabilities;
ortc.validateSctpStreamParameters;
ortc.validateSctpParameters;
ortc.validateNumSctpStreams;
ortc.validateSctpCapabilities;
ortc.validateRtcpParameters;
ortc.validateRtpEncodingParameters;
ortc.validateRtpHeaderExtensionParameters;
ortc.validateRtpCodecParameters;
ortc.validateRtpParameters;
ortc.validateRtpHeaderExtension;
ortc.validateRtcpFeedback;
ortc.validateRtpCodecCapability;
ortc.validateRtpCapabilities;
...
class Logger {
    constructor(prefix) {
        if (prefix) {
            this._debug = (0, browser.default)(`${LIB_NAME}:${prefix}`);
            this._warn = (0, browser.default)(`${LIB_NAME}:WARN:${prefix}`);
            this._error = (0, browser.default)(`${LIB_NAME}:ERROR:${prefix}`);
        }
        else {
            this._debug = (0, browser.default)(LIB_NAME);
            this._warn = (0, browser.default)(`${LIB_NAME}:WARN`);
            this._error = (0, browser.default)(`${LIB_NAME}:ERROR`);
        }
        /* eslint-disable no-console */
        this._debug.log = console.info.bind(console);
        this._warn.log = console.warn.bind(console);
...
unwrapExports(lib$2);
lib$2.AwaitQueue;
lib$2.AwaitQueueRemovedTaskError;
lib$2.AwaitQueueStoppedError;
...
commonUtils.getCname;
commonUtils.extractDtlsParameters;
commonUtils.extractRtpCapabilities;
...
unifiedPlanUtils.getRtpEncodings;
...
MediaSection_1.OfferMediaSection;
MediaSection_1.AnswerMediaSection;
MediaSection_1.MediaSection;
...
const logger = new Logger_1$1.Logger('RemoteSdp');
class RemoteSdp {
...
const utils$2 = __importStar(utils$1);
const ortc$1 = __importStar(ortc);
const sdpCommonUtils = __importStar(commonUtils);
const sdpUnifiedPlanUtils = __importStar(unifiedPlanUtils);
const ortcUtils = __importStar(utils);




const logger = new Logger_1$1.Logger('Chrome111');
...
const logger = new Logger_1$1.Logger('Chrome74');
const SCTP_NUM_STREAMS = { OS: 1024, MIS: 1024 };
...
const logger = new Logger_1$1.Logger('Chrome70');
const SCTP_NUM_STREAMS = { OS: 1024, MIS: 1024 };
...
const logger = new Logger_1$1.Logger('Chrome67');
const SCTP_NUM_STREAMS = { OS: 1024, MIS: 1024 };
...
const logger = new Logger_1$1.Logger('Chrome55');
const SCTP_NUM_STREAMS = { OS: 1024, MIS: 1024 };
...
const logger = new Logger_1$1.Logger('Firefox60');
...
const logger = new Logger_1$1.Logger('Safari12');
const SCTP_NUM_STREAMS = { OS: 1024, MIS: 1024 };
...
const logger = new Logger_1$1.Logger('Safari11');
const SCTP_NUM_STREAMS = { OS: 1024, MIS: 1024 };
...
const logger = new Logger_1$1.Logger('Edge11');
...
const logger = new Logger_1$1.Logger('ReactNativeUnifiedPlan');
const SCTP_NUM_STREAMS = { OS: 1024, MIS: 1024 };
...
ReactNativeUnifiedPlan_1.ReactNativeUnifiedPlan;
...
const logger = new Logger_1$1.Logger('ReactNative');
const SCTP_NUM_STREAMS = { OS: 1024, MIS: 1024 };
...
const logger = new Logger_1$1.Logger('Device');
function detectDevice() {
    ...
    // Browser.
        ...
        const device = uaParser$1.getDevice();
...
var lib_1 = lib.debug;
var lib_2 = lib.parseScalabilityMode;
var lib_3 = lib.detectDevice;
var lib_4 = lib.Device;
var lib_5 = lib.version;
var lib_6 = lib.types;

export { lib_4 as Device, lib_1 as debug, index as default, lib_3 as detectDevice, lib_2 as parseScalabilityMode, lib_6 as types, lib_5 as version };

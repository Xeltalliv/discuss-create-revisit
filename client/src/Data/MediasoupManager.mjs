import mediasoupClient from "../libs/mediasoup-client.mjs";
...
class MediasoupManager {
	constructor(main, baseUI, userManager) {
		this.main = main;
		this.baseUI = baseUI;
		...
		main.networkManager.addHandler("mediasoup", (op, data) => {
			...
			if (audioTrack) {
				audioTrack.addEventListener("ended", async () => {
					...
					if (this.userMediaAudio.getTracks().length == 0) {
						this.userMediaAudio = null;
						this.baseUI.userManager.me.mediaUpdate(this);
